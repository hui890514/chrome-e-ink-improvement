...
export function applyInkStyle() {
  ...
  log('chrome-e-ink-improvement: apply ink style')
}

export function removeInkStyle() {
  window.location.reload()
  log('chrome-e-ink-improvement: remove ink style')
}

export async function shouldApplyInkStyle(host) {
  return await getStorageAsync(host)
}
